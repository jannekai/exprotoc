defmodule TestWrapperTest do
  ...
  test "encode uint32" do
    ...
    p = t |> Proto.Test.Test1.encode |> IO.iodata_to_binary
    assert p == <<8, 255, 255, 255, 255, 7>>
  end

  test "decode uint32" do
    t = Proto.Test.Test1.decode <<16, 0, 8, 255, 255, 255, 255, 7>>
    assert t[:a] == 2147483647
  end
  ...
  test "decode sint64" do
    t = Proto.Test.Test1.decode <<16, 128, 128, 128, 128, 16, 8, 0>>
  ...
  test "encode enum" do
    ...
    payload = t |> Proto.Test.Test2.encode |> IO.iodata_to_binary
  ...
  test "encode nested message" do
    ...
    payload = outer |> Proto.Test.Test3.encode |> IO.iodata_to_binary
  ...
  test "encode repeated message" do
    ...
    payload = message |> Proto.Test.Test4.encode |> IO.iodata_to_binary
  ...
  test "encode nested repeated messages" do
    ...
    payload = message |> Proto.Test.Test5.encode |> IO.iodata_to_binary
  ...
  test "encode bool" do
    ...
    payload = message |> Proto.Test.Test7.encode |> IO.iodata_to_binary
    assert payload == << 8, 1 >>
  end
  ...
  test "encode external enum" do
    ...
    payload = message |> Proto.Test.Test9.encode |> IO.iodata_to_binary
    assert payload == << 8, 150, 1 >>
  end
  ...
  test "encode external message" do
    ...
    payload = message |> Proto.Test.Test10.encode |> IO.iodata_to_binary
  ...
  test "incode imported message" do
    ...
    payload = message |> Proto.Test.Test11.encode |> IO.iodata_to_binary
    assert payload == << 10, 3, 8, 150, 1 >>
  end
  ...
  test "encode nested imported message" do
    ...
    payload = message |> Proto.Test.Test12.encode |> IO.iodata_to_binary
    assert payload == << 10, 3, 8, 150, 1 >>
  end
  ...
  test "missing package header" do
    ...
    payload = message |> Proto.NoPackage.encode |> IO.iodata_to_binary
    assert payload == << 8, 150, 1 >>
  ...
  test "encode field with defaults" do
    ...
    payload = message |> Proto.Test.Test13.encode |> IO.iodata_to_binary
    assert payload == <<>>
  end
  ...
  test "get_and update protocol" do
    inner = Proto.Test.Test1.new a: 150
    outer = Proto.Test.Test3.new c: inner
    {val, message1} = get_and_update_in(outer, [:c, :a], &{&1, 5})
    assert val == 150
    assert message1[:c][:a] == 5
  end
